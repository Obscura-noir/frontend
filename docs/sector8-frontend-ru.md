...
#### 15.2.2 Настройка пользовательского списка кошельков
...
#### 15.3.2 Индикатор статуса кошелька
...
#### 15.7.2 Фаза 2: Расширенная поддержка (2-3 недели)
